...
export default function RateSetupControls() {
  ...
  const [markupType, setMarkupType] = useState<"percentage" | "flat">(
    "percentage",
  );
  ...
  const markup =
    markupType === "percentage" ? baseRate * (markupValue / 100) : 1607500;
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={sellingRateSource}
              onValueChange={setSellingRateSource}
            >
              <SelectTrigger className="bg-white border-gray-300">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <div className="flex">
              <Button
                ...
                className={`rounded-r-none text-sm px-3 py-2 h-auto ${markupType === "percentage" ? "bg-yellow-500 hover:bg-yellow-600 text-white" : "bg-white border-gray-300 text-gray-700"}`}
              ...
              <Button
                ...
                className={`rounded-l-none text-sm px-3 py-2 h-auto ${markupType === "flat" ? "bg-yellow-500 hover:bg-yellow-600 text-white" : "bg-white border-gray-300 text-gray-700"}`}
                onClick={() => {
                  setMarkupType("flat");
