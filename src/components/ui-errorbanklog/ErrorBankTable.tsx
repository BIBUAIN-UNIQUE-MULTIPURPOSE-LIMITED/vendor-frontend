...
export default function ErrorBankTable() {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200">
      {/* Filter Section */}
      <div className="bg-gray-100 px-4 py-3 mb-6 rounded-md border border-gray-200">
          ...
          <div className="min-w-40">
            <Select value={issueFilter} onValueChange={setIssueFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Can't Withdraw">
                  Can&apos;t Withdraw
                </SelectItem>
                <SelectItem value="PND (Post No Debit)">
                  PND (Post No Debit)
                </SelectItem>
                <SelectItem value="Downgraded to tier 2">
                  Downgraded to tier 2
                </SelectItem>
                <SelectItem value="Downgraded to Tier 1">
                  Downgraded to Tier 1
                </SelectItem>
                <SelectItem value="Login Blocked">Login Blocked</SelectItem>
                <SelectItem value="Cannot Receive Transfers">
                  Cannot Receive Transfers
                </SelectItem>
                <SelectItem value="Withdraw Delayed">
                  Withdraw Delayed
                </SelectItem>
              </SelectContent>
            </Select>
            ...
            {filteredLogs.map((log, index) => (
              ...
              >
                ...
                <td className="py-4 px-4 text-gray-700">
                  ₦{log.amountAffected.toLocaleString()}
                </td>
