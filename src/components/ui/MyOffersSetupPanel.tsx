    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={platformSelector}
                onValueChange={setPlatformSelector}
              >
                <SelectTrigger className="bg-white border-gray-300">
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <div className="flex">
                <Button
                  ...
                  className={`flex-1 rounded-r-none text-sm px-4 py-2 h-auto ${tradeType === "buy" ? "bg-yellow-500 hover:bg-yellow-600 text-white" : "bg-white border-gray-300 text-gray-700"}`}
                ...
                <Button
                  ...
                  className={`flex-1 rounded-l-none text-sm px-4 py-2 h-auto ${tradeType === "sell" ? "bg-yellow-500 hover:bg-yellow-600 text-white" : "bg-white border-gray-300 text-gray-700"}`}
        ...
        <div className="mt-8 flex justify-end">
          <Button className="w-60 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 text-lg">
            Create offer
          </Button>
        </div>
