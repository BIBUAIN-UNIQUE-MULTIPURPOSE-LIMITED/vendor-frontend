...
import { Select, SelectContent } from "@/components/shadcn/ui/select";
import { SelectGroup, SelectItem } from "@/components/shadcn/ui/select";
import {
  SelectLabel,
  SelectTrigger,
  SelectValue,
        ...
        <div className="grid gap-3 grid-cols-12">
          ...
          <div className="col-span-12 @xl/grid:col-span-6 @3xl/grid:col-span-4">
            <div className="space-y-1">
              ...
              <Input
                type="time"
                placeholder="Enter total coin purchased"
